...
/**
 * VehicleControl: convert carla_msgs::msg::CarlaEgoVehicleControl into FVehicleControl without the need of
 * knowing FVehicleControl class within LibCarla
 */
class VehicleControl {
public:
  explicit VehicleControl(const carla_msgs::msg::CarlaEgoVehicleControl& vehicle_control)
  ...
  carla_msgs::msg::CarlaEgoVehicleControl const& carla_vehicle_control() const {
...
private:
  carla_msgs::msg::CarlaEgoVehicleControl _vehicle_control;
};
}  // namespace types
}  // namespace ros2
}  // namespace carla