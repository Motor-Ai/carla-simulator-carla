...
using VehicleControlSubscriberImpl =
    DdsSubscriberImpl<carla_msgs::msg::CarlaEgoVehicleControl, carla_msgs::msg::CarlaEgoVehicleControlPubSubType>;

class VehicleControlSubscriber : public SubscriberBase<carla_msgs::msg::CarlaEgoVehicleControl> {
public:
