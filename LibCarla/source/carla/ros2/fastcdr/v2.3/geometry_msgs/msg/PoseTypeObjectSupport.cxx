        ...
        TypeIdentifierPair& type_ids_Pose)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Pose)
    {
        ...
        eprosima::fastcdr::optional<AppliedVerbatimAnnotation> verbatim_Pose;
        PlacementKind placement_Pose = PlacementKind::BEFORE_DECLARATION;
        eprosima::fastcdr::fixed_string<32> language_Pose = "*";
        std::string text_Pose;
        language_Pose = "comment";

        placement_Pose = PlacementKind::BEFORE_DECLARATION;

        text_Pose = "A representation of pose in free space, composed of position and orientation.";

        verbatim_Pose = TypeObjectUtils::build_applied_verbatim_annotation(placement_Pose, language_Pose, text_Pose);
        type_ann_builtin_Pose = TypeObjectUtils::build_applied_builtin_type_annotations(verbatim_Pose);

        if (!tmp_ann_custom_Pose.empty())
        {
            ann_custom_Pose = tmp_ann_custom_Pose;
        }
