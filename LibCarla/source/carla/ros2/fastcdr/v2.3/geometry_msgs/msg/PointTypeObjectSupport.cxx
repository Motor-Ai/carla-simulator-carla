        ...
        TypeIdentifierPair& type_ids_Point)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Point)
    {
        ...
        AppliedAnnotationSeq tmp_ann_custom_Point;
        eprosima::fastcdr::optional<AppliedVerbatimAnnotation> verbatim_Point;
        PlacementKind placement_Point = PlacementKind::BEFORE_DECLARATION;
        eprosima::fastcdr::fixed_string<32> language_Point = "*";
        std::string text_Point;
        language_Point = "comment";

        placement_Point = PlacementKind::BEFORE_DECLARATION;

        text_Point = "This contains the position of a point in free space";

        verbatim_Point = TypeObjectUtils::build_applied_verbatim_annotation(placement_Point, language_Point, text_Point);
        type_ann_builtin_Point = TypeObjectUtils::build_applied_builtin_type_annotations(verbatim_Point);

        if (!tmp_ann_custom_Point.empty())
        {
            ann_custom_Point = tmp_ann_custom_Point;
        }
