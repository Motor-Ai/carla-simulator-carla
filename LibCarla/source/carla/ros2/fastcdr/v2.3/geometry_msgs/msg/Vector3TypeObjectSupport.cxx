        ...
        TypeIdentifierPair& type_ids_Vector3)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Vector3)
    {
        ...
        AppliedAnnotationSeq tmp_ann_custom_Vector3;
        eprosima::fastcdr::optional<AppliedVerbatimAnnotation> verbatim_Vector3;
        PlacementKind placement_Vector3 = PlacementKind::BEFORE_DECLARATION;
        eprosima::fastcdr::fixed_string<32> language_Vector3 = "*";
        std::string text_Vector3;
        language_Vector3 = "comment";

        placement_Vector3 = PlacementKind::BEFORE_DECLARATION;

        text_Vector3 = "This represents a vector in free space.";

        verbatim_Vector3 = TypeObjectUtils::build_applied_verbatim_annotation(placement_Vector3, language_Vector3, text_Vector3);
        type_ann_builtin_Vector3 = TypeObjectUtils::build_applied_builtin_type_annotations(verbatim_Vector3);

        if (!tmp_ann_custom_Vector3.empty())
        {
            ann_custom_Vector3 = tmp_ann_custom_Vector3;
        }
