...
/*!
 * @file CarlaCollisionEvent.hpp
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool fastddsgen (version: 4.0.5).
 */

#ifndef FAST_DDS_GENERATED__CARLA_MSGS_MSG_CARLACOLLISIONEVENT_HPP
#define FAST_DDS_GENERATED__CARLA_MSGS_MSG_CARLACOLLISIONEVENT_HPP
...
public:
     ...
     * @param x Reference to the object CarlaCollisionEvent that will be copied.
     */
    eProsima_user_DllExport CarlaCollisionEvent(
     ...
     * @param x CarlaCollisionEvent object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_CARLA_MSGS_MSG_CARLACOLLISIONEVENT_HPP_
