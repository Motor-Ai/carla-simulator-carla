...
/*!
 * @file GetBlueprints.hpp
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool fastddsgen (version: 4.0.5).
 */

#ifndef FAST_DDS_GENERATED__CARLA_MSGS_SRV_GETBLUEPRINTS_HPP
#define FAST_DDS_GENERATED__CARLA_MSGS_SRV_GETBLUEPRINTS_HPP
...
public:
     ...
     * @param x Reference to the object GetBlueprints_Request that will be copied.
     */
    eProsima_user_DllExport GetBlueprints_Request(
     ...
     * @param x GetBlueprints_Request object to compare.
     */
...
public:
    ...
    /*!
     * @brief Copy constructor.
     * @param x Reference to the object GetBlueprints_Response that will be copied.
     */
    eProsima_user_DllExport GetBlueprints_Response(
    ...
    /*!
     * @brief Comparison operator.
     * @param x GetBlueprints_Response object to compare.
     */
    eProsima_user_DllExport bool operator ==(
...
#endif // _FAST_DDS_GENERATED_CARLA_MSGS_SRV_GETBLUEPRINTS_HPP_
