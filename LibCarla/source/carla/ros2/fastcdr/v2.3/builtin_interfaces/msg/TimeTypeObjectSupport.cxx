        ...
        TypeIdentifierPair& type_ids_Time)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Time)
    {
        ...
        AppliedAnnotationSeq tmp_ann_custom_Time;
        eprosima::fastcdr::optional<AppliedVerbatimAnnotation> verbatim_Time;
        PlacementKind placement_Time = PlacementKind::BEFORE_DECLARATION;
        eprosima::fastcdr::fixed_string<32> language_Time = "*";
        std::string text_Time;
        language_Time = "comment";

        placement_Time = PlacementKind::BEFORE_DECLARATION;

        text_Time = "This message communicates ROS Time defined here:\nhttps://design.ros2.org/articles/clock_and_time.html";

        verbatim_Time = TypeObjectUtils::build_applied_verbatim_annotation(placement_Time, language_Time, text_Time);
        type_ann_builtin_Time = TypeObjectUtils::build_applied_builtin_type_annotations(verbatim_Time);

        if (!tmp_ann_custom_Time.empty())
        {
            ann_custom_Time = tmp_ann_custom_Time;
        }
