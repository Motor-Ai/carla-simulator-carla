...
/*!
 * @file SolidPrimitiveWithCovariance.hpp
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool fastddsgen (version: 4.0.5).
 */

#ifndef FAST_DDS_GENERATED__DERIVED_OBJECT_MSGS_MSG_SOLIDPRIMITIVEWITHCOVARIANCE_HPP
#define FAST_DDS_GENERATED__DERIVED_OBJECT_MSGS_MSG_SOLIDPRIMITIVEWITHCOVARIANCE_HPP
...
public:
     ...
     * @param x Reference to the object SolidPrimitiveWithCovariance that will be copied.
     */
    eProsima_user_DllExport SolidPrimitiveWithCovariance(
     ...
     * @param x SolidPrimitiveWithCovariance object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_DERIVED_OBJECT_MSGS_MSG_SOLIDPRIMITIVEWITHCOVARIANCE_HPP_
