...
/*!
 * @file ObjectArray.hpp
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool fastddsgen (version: 4.0.5).
 */

#ifndef FAST_DDS_GENERATED__DERIVED_OBJECT_MSGS_MSG_OBJECTARRAY_HPP
#define FAST_DDS_GENERATED__DERIVED_OBJECT_MSGS_MSG_OBJECTARRAY_HPP
...
public:
     ...
     * @param x Reference to the object ObjectArray that will be copied.
     */
    eProsima_user_DllExport ObjectArray(
            const ObjectArray& x)
    {
     ...
     * @param x ObjectArray object to compare.
     */
     ...
     */
    eProsima_user_DllExport const std::vector<Object>& objects() const
    {
        return m_objects;
    }
     ...
     */
    eProsima_user_DllExport std::vector<Object>& objects()
    {
        return m_objects;
    }
...
#endif // _FAST_DDS_GENERATED_DERIVED_OBJECT_MSGS_MSG_OBJECTARRAY_HPP_
