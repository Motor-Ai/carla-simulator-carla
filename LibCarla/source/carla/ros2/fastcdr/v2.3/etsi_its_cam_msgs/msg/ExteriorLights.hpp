...
/*!
 * @file ExteriorLights.hpp
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool fastddsgen (version: 4.0.5).
 */

#ifndef FAST_DDS_GENERATED__ETSI_ITS_CAM_MSGS_MSG_EXTERIORLIGHTS_HPP
#define FAST_DDS_GENERATED__ETSI_ITS_CAM_MSGS_MSG_EXTERIORLIGHTS_HPP
...
public:
     ...
     * @param x Reference to the object ExteriorLights that will be copied.
     */
    eProsima_user_DllExport ExteriorLights(
     ...
     * @param x ExteriorLights object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_ETSI_ITS_CAM_MSGS_MSG_EXTERIORLIGHTS_HPP_
