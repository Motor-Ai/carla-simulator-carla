...
#ifndef FAST_DDS_GENERATED__TF2_MSGS_MSG_TFMESSAGE_HPP
#define FAST_DDS_GENERATED__TF2_MSGS_MSG_TFMESSAGE_HPP
...
public:
     ...
     * @param x Reference to the object TFMessage that will be copied.
     */
    eProsima_user_DllExport TFMessage(
            const TFMessage& x)
    {
     ...
     * @param x TFMessage object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_TF2_MSGS_MSG_TFMESSAGE_HPP_
