        ...
        TypeIdentifierPair& type_ids_Header)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Header)
    {
        ...
        PlacementKind placement_Header = PlacementKind::BEFORE_DECLARATION;
        eprosima::fastcdr::fixed_string<32> language_Header = "*";
        std::string text_Header;
        language_Header = "comment";

        placement_Header = PlacementKind::BEFORE_DECLARATION;

        text_Header = "Standard metadata for higher-level stamped data types.\nThis is generally used to communicate timestamped data\nin a particular coordinate frame.";

        verbatim_Header = TypeObjectUtils::build_applied_verbatim_annotation(placement_Header, language_Header, text_Header);
        type_ann_builtin_Header = TypeObjectUtils::build_applied_builtin_type_annotations(verbatim_Header);
