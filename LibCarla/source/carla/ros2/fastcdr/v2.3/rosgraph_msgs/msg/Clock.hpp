...
#ifndef FAST_DDS_GENERATED__ROSGRAPH_MSGS_MSG_CLOCK_HPP
#define FAST_DDS_GENERATED__ROSGRAPH_MSGS_MSG_CLOCK_HPP
...
public:
     ...
     * @param x Reference to the object Clock that will be copied.
     */
    eProsima_user_DllExport Clock(
            const Clock& x)
    {
     ...
     * @param x Clock object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_ROSGRAPH_MSGS_MSG_CLOCK_HPP_
