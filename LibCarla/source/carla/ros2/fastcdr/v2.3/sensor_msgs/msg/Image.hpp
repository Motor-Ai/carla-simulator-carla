...
/*!
 * @brief This class represents the structure ImageT defined by the user in the IDL file.
 * @ingroup ImageT
 */
...
public:
  ...
  using vector_type = std::vector<base_type, allocator_type>;

    /*!
     * @brief Default constructor.
     */
    eProsima_user_DllExport ImageT()
    {
    }
     ...
     * @param x Reference to the object ImageT that will be copied.
     */
    eProsima_user_DllExport ImageT(
     ...
     * @param x Reference to the object ImageT that will be copied.
     */
    eProsima_user_DllExport ImageT& operator =(
            const ImageT<ALLOCATOR>& x)
    {
     ...
     * @param x ImageT object to compare.
     */
     ...
     */
    eProsima_user_DllExport const vector_type& data() const
    {
        return m_data;
    }
     ...
     */
    eProsima_user_DllExport vector_type& data()
    {
        return m_data;
    }
...
using ImageFromBuffer = ImageT<carla::sensor::data::SerializerVectorAllocator<uint8_t>>;
using Image = ImageT<std::allocator<uint8_t>>;
